...
public class AÒadirAsignaciones implements WindowListener,ActionListener
{

	Frame frmAsignaciones = new Frame("Alta Asignaci√≥n Tratamiento");
	...
	Label lblErrorAnadidoTratamiento = new Label("Error al a√±adir Tratamiento");
	...
	public AÒadirAsignaciones(String idCita, String[] clienteSeleccionado) {
		datoCita = idCita;
